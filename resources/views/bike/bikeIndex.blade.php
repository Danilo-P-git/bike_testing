            ...
            <div class="form-row">
                ...
                {{-- <div id="priceCat"> --}}
                    ...
                    <div class="form-group col-md-2 col-lg-1 col-4 priceCat" style="display: none">
                        ...
                        <input type="number" name="twoDay" class="form-control" id="twoDay" >
                    </div>
                    

                    <div class="form-group col-md-2 col-lg-1 col-4 priceCat" style="display: none">
                        <label for="threeDay">3 giorni</label>
                        <input type="number" name="threeDay" class="form-control" id="threeDay" >
                    </div>
                    

                    <div class="form-group col-md-2 col-lg-1 col-4 priceCat" style="display: none">
                        <label for="fourDay">4 giorni</label>
                        <input type="number" name="fourDay" class="form-control" id="fourDay" >
                    </div>
                    

                    <div class="form-group col-md-2 col-lg-1 col-4 priceCat" style="display: none">
                        <label for="fiveDay">5 giorni</label>
                        <input type="number" name="fiveDay" class="form-control" id="fiveDay" >
                    </div>
                    

                    <div class="form-group col-md-2 col-lg-1 col-4 priceCat" style="display: none">
                        <label for="sixDay">6 giorni</label>
                        <input type="number" name="sixDay" class="form-control" id="sixDay" >
                    </div>
                    

                    <div class="form-group col-md-2 col-lg-1 col-4 priceCat" style="display: none">
                        <label for="sevenDay">7 giorni</label>
                        <input type="number" name="sevenDay" class="form-control" id="sevenDay" >
                    </div>
